...
{
    public class BoldLabel : Element
    {
        ...
        protected override void Repaint(Rect drawRect)
        {
            ...
            EditorStyles.boldLabel.CalcMinMaxWidth(new GUIContent(_text), out _, out var maxWidth);
            _lineCount = Mathf.CeilToInt(maxWidth / GetMaxWidth());
            UnityEngine.GUI.Label(drawRect, _text, EditorStyles.boldLabel);
